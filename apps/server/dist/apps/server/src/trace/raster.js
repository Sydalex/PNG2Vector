...
exports.morphologyCleanup = morphologyCleanup;
exports.removeSpeckles = removeSpeckles;
exports.preprocessRaster = preprocessRaster;
/**
 ...
 */
function morphologyCleanup(imageData, iterations = 1) {
 ...
 */
function removeSpeckles(imageData, minArea) {
    const { width, height, data } = imageData;
 ...
 */
function preprocessRaster(imageData, options = {}) {
...
function morphologyDilation(imageData) {
    const { width, height, data } = imageData;
...
function morphologyErosion(imageData) {
    const { width, height, data } = imageData;
