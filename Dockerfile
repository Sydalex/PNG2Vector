# filename: Dockerfile
# Railway-optimized multi-stage build for PNG to SVG/DXF converter
...
# Fix known package version issues
...
# Set ONNX environment variables for CPU-only mode
ENV ORT_DYLIB_PATH=""
